 ...
 * mostra "AGORA") + separador + engrenagem que abre as configurações.
 */
export default function MapDateCard({ onOpenSettings }: MapDateCardProps) {
  return (
